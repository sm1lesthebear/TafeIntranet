...
-- Reports
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Bailey S. - Report', 'RESOURCES/Uploaded_Documents/Bailey_Slee_Sustainability_Final_Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Dianne F. - Report', 'RESOURCES/Uploaded_Documents/DianneF_SustainabilityReport_08112016.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jaiden S. - Report', 'RESOURCES/Uploaded_Documents/JaidenSmith_Sustainability_Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jake R. - Report', 'RESOURCES/Uploaded_Documents/Jake Ronayne_Sustainability_Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jake S. - Report', 'RESOURCES/Uploaded_Documents/JakeS_Sustainability_Report_8-11-2016.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jason P. - Report', 'RESOURCES/Uploaded_Documents/Jason Parre_Sustainability_Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jason G. - Report', 'RESOURCES/Uploaded_Documents/JASON-GRAVESTOCK_Sustainability_PROJECT-Report_10-11-2016.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jonathan S. - Report', 'RESOURCES/Uploaded_Documents/JonathanS_Sustainability_Final Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jordan B. - Report - 1', 'RESOURCES/Uploaded_Documents/Jordan_Bryan_Sustainability_Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Jordan B. - Report - 2', 'RESOURCES/Uploaded_Documents/Jordan_Sustainability_Report.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Justin S. - Report', 'RESOURCES/Uploaded_Documents/Justin_Stean_Sustainability_Reportv2.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Kieren P. - Report', 'RESOURCES/Uploaded_Documents/KierenP_Sustainablilty_Report_081116.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Kynan B. - Report', 'RESOURCES/Uploaded_Documents/Kynan_Brown_Sustainability_Report_10-11-2016.pdf', 6, 2);
INSERT INTO tbl_doc (fldName, fldLocation, fldFkDocTypeId, fldFkDocCategoryId)
VALUES ('Leo C. - Report', 'RESOURCES/Uploaded_Documents/LEOCORONEOS_Sustainability_REPORT_10112016v2.pdf', 6, 2);


INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (1, 2);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (2, 2);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (3, 3);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (4, 3);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (5, 3);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (6, 1);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (7, 2);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (8, 2);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (9, 1);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (10, 1);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (11, 2);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (12, 1);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (13, 1);
INSERT INTO tbl_sus_doc_bridge (fldFKDocID, fldFKSusID) VALUES (14, 1);


insert into tbl_stakeholders
(fldFirstName, fldLastName, fldImageLocation, fldInfo)
values
("Ramin", "Majidi", "RESOURCES/StakeholderImages/ramin-majidi.jpg", "Ramin Majidi (2 October 1869 – 30 January 1948) was the preeminent leader of the D-Block Information comunnications technology in Moron-Ruled Australia. 
Employing nonviolent civil disobedience, Rmain led Australia to independence and inspired movements for civil rights and freedom across the world. 
The honorific Ramin (high-souled/venerable) applied to him first in 1914 in South Africa, is now used worldwide. 
He is also called Majidi (endearment for 'father/papa') by Troy. 
In common parlance in D-Block he is often called The Raminator. He is unofficially called the Father of the Nation."),
("James", "White", "RESOURCES/StakeholderImages/james-white.jpg", "“I’m James White, and this is my pawn shop. I work here with my old man and my son, Big Hoss. Everything in here has a story and a price. One thing I’ve learned after 21 years – you never know WHAT is gonna come through that door.”"),
("Brockman", "Searle", "RESOURCES/StakeholderImages/brockman-searle.jpg", "According to all known laws of aviation,
